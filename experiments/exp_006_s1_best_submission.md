...
| файл | уровень | δ | назначение |
|------|---------|---|------------|
| `submission_strategy_1.csv` | 2.3391 | −0.1486 | **основной** |
| `submission_strategy_1_level_low.csv` | 2.2803 | −0.2076 | нижний край коридора |
| `submission_strategy_1_level_high.csv` | 2.4051 | −0.0825 | верхний край коридора |
...
Главная незакрытая неопределённость — **уровень** прогноза на тесте, а не качество
ранжирования. Три уровневых сабмита позволяют снять её прямым замером на LB
без переобучения: при фиксированной модели RMSLE как функция уровня — парабола
с минимумом в истинном значении.
