...
- **Catalogue ID:** `eda__e04_hidden_structure`
- **Namespace:** `eda`
- **Experiment ID:** `e04_hidden_structure`
- **Original source:** `research/eda/e04_hidden_structure.py`
...
- **Postprocessing:** print("B. USER-LEVEL SPAN: cohorts / first & last activity")
...
# e04_hidden_structure

Original script: `research/eda/e04_hidden_structure.py`
