...
- **Catalogue ID:** `eda__e05_selection_seasonality`
- **Namespace:** `eda`
- **Experiment ID:** `e05_selection_seasonality`
- **Original source:** `research/eda/e05_selection_seasonality.py`
...
- **Known score:** anchor[c] = dict(persist=rmsle(y, p30), persist116=rmsle(y, p30 * 1.1628),
...
# e05_selection_seasonality

Original script: `research/eda/e05_selection_seasonality.py`
