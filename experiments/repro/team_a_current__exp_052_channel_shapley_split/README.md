...
- **Catalogue ID:** `team_a_current__exp_052_channel_shapley_split`
- **Namespace:** `team_a_current`
- **Experiment ID:** `exp_052_channel_shapley_split`
- **Original source:** `experiments/exp_052_channel_shapley_split.md`
