# Teammate candidate — trust_p_spread_ridge_recentpow1p7_s075

## Catalogue metadata

- **Catalogue ID:** `teammate_candidate__trust_p_spread_ridge_recentpow1p7_s075`
- **Namespace:** `teammate_candidate`
- **Experiment ID:** `trust_p_spread_ridge_recentpow1p7_s075`
...
- **Known score:** | wcv | 1.7483908539217363 |
- **Seed:** Seed from src/config.py unless the preserved card explicitly states otherwise
- **Postprocessing:** None documented
- **Submission:** None documented
- **External data/artifacts:** Competition train.parquet and sample_submit.csv; additional artifacts are listed in the card
- **Reproducibility:** PARTIAL: exact result rows and runner code survive; checkpoint bank and raw data are external
- **Notes:** Recovered from 12 result-table row(s); no score or parameter was inferred.
...
| Field | Value |
|---|---|
| name | trust_p_spread_ridge_recentpow1p7_s075 |
| family | local_trust |
| wcv | 1.7483908539217363 |
| base_wcv | 1.749803702558191 |
| delta | -0.0014128486364547517 |
| wins | 2 |
| wins_recent | 2 |
| latest_delta | -0.0018359203223892173 |
| worst_delta | 0.0 |
| raw_delta | -0.0020094345102471324 |
| offset_mean | -0.0431249293743042 |
| offset_std | 0.05246168386064271 |
| fold_scores | [1.7692437685920095, 1.7627250202953268, 1.7493634085208671, 1.741714420694989] |
| fold_deltas | [0.0, 0.0, -0.0016263417419268844, -0.0018359203223892173] |
| notes |  |
...
| name | trust_p_spread_ridge_recentpow1p7_s075 |
| family | local_trust |
| wcv | 1.748386168290204 |
| base_wcv | 1.749803702558191 |
| delta | -0.0014175342679870677 |
| wins | 2 |
| wins_recent | 2 |
| latest_delta | -0.001832240138416319 |
| worst_delta | 0.0 |
| raw_delta | -0.002014852165437612 |
| offset_mean | -0.04301585883473542 |
| offset_std | 0.05254787790727214 |
| fold_scores | [1.7692437685920095, 1.7627250202953268, 1.7493384770346752, 1.741718100878962] |
| fold_deltas | [0.0, 0.0, -0.0016512732281188658, -0.001832240138416319] |
| notes |  |
...
| name | trust_p_spread_ridge_recentpow1p7_s075 |
| family | local_trust |
| wcv | 1.74851198011068 |
| base_wcv | 1.749803702558191 |
| delta | -0.0012917224475111528 |
| wins | 2 |
| wins_recent | 2 |
| latest_delta | -0.0016446569719004156 |
| worst_delta | 0.0 |
| raw_delta | -0.0018920170005577812 |
| offset_mean | -0.04395017877674467 |
| offset_std | 0.05158521861868083 |
| fold_scores | [1.7692437685920095, 1.7627250202953268, 1.749435105028428, 1.7419056840454779] |
| fold_deltas | [0.0, 0.0, -0.0015546452343659922, -0.0016446569719004156] |
| notes |  |
