...
- **Catalogue ID:** `new_direction__exp089_joint_v2_plane_resolution`
- **Namespace:** `new_direction`
- **Experiment ID:** `EXP089_JOINT_V2_PLANE_RESOLUTION`
- **Original source:** `research/new_directions/EXP089_JOINT_V2_PLANE_RESOLUTION`
...
- **Known score:** predicts a diagnostic optimum at RMSLE `1.645894652126`
...
- **Notes:** Directory-level audit unit: 9 files, 1 launcher/helper scripts, 1 preserved report documents. Numeric claims are copied from those reports.
