...
- **Catalogue ID:** `new_direction__exp087_dynamic_factor_residual`
- **Namespace:** `new_direction`
- **Experiment ID:** `EXP087_DYNAMIC_FACTOR_RESIDUAL`
- **Original source:** `research/new_directions/EXP087_DYNAMIC_FACTOR_RESIDUAL`
...
- **Notes:** Directory-level audit unit: 10 files, 1 launcher/helper scripts, 1 preserved report documents. Numeric claims are copied from those reports.
