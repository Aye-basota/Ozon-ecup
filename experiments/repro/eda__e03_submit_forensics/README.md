...
- **Catalogue ID:** `eda__e03_submit_forensics`
- **Namespace:** `eda`
- **Experiment ID:** `e03_submit_forensics`
- **Original source:** `research/eda/e03_submit_forensics.py`
...
- **Known score:** f"close={100*close:6.2f}% rlog={r_log:6.4f} RMSLE={rmsle:7.4f}")
...
# e03_submit_forensics

Original script: `research/eda/e03_submit_forensics.py`
