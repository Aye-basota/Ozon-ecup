...
- **Catalogue ID:** `new_direction__exp083_information_loss_discovery`
- **Namespace:** `new_direction`
- **Experiment ID:** `EXP083_INFORMATION_LOSS_DISCOVERY`
- **Original source:** `research/new_directions/EXP083_INFORMATION_LOSS_DISCOVERY`
- **Source ref:** `origin/team-a late research package`
- **Source commit:** `cdf74c77108e3b731f9ecb4f4e8f7b198cbded66`
- **Kind:** late research direction / experiment package
- **Model:** LightGBM, BTYD, Ridge
...
- **Known score:** Delta RMSLE                 = +0.000301621
...
- **Notes:** Directory-level audit unit: 17 files, 2 launcher/helper scripts, 1 preserved report documents. Numeric claims are copied from those reports.
