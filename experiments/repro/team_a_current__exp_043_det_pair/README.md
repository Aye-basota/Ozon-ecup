...
- **Catalogue ID:** `team_a_current__exp_043_det_pair`
- **Namespace:** `team_a_current`
- **Experiment ID:** `exp_043_det_pair`
- **Original source:** `experiments/exp_043_det_pair.md`
...
- **Validation:** `src/validation.py`, `src/config.py` не изменялись
- **Known score:** `|ΔRMSLE_cal| = 0.00033`, `Var(Δz) = 0.02041`. Известный механизм — три CPU
- **Seed:** эффекты всё равно надо мерить парно на одном plan и подтверждать по фолдам/сидам.
