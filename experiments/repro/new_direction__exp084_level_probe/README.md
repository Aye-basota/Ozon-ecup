...
- **Catalogue ID:** `new_direction__exp084_level_probe`
- **Namespace:** `new_direction`
- **Experiment ID:** `EXP084_LEVEL_PROBE`
- **Original source:** `research/new_directions/EXP084_LEVEL_PROBE`
...
- **Known score:** | `>= 0.05` | крупная находка, способная объяснить существенную часть LB gap |
