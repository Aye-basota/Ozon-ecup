...
from src.validation import bias_z, gap_curve_folds, rmsle_z
...
def main():
    ...
    load()
    Xv, yv = make_xy(S2_VAL, s.L, s.panel_blocks)
    ...
    np.save(f"artifacts/ztest_L{s.L}_tb{s.train_blocks}.npy", zt)
