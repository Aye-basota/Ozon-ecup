...
def main():
    ...
    parser.add_argument("--raw-data", type=Path, default=ROOT / "data" / "train.parquet")
    parser.add_argument("--output", type=Path, default=SUBMISSIONS / DEFAULT_OUTPUT)
    args = parser.parse_args()
    print("read train data", flush=True)
    df_raw = pd.read_parquet(args.raw_data)
