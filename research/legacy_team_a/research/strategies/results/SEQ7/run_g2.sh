#!/usr/bin/env bash
# EXP-030 multi-seed, GPU-B (A10 #2, vm9161) — СИД 44, все 4 фолда, парно BASE vs D3A.
#
# Отличие от `SEQ5/run.sh`: `--seed 44` и `--compile` (65.2 мс/шаг против 129.9
